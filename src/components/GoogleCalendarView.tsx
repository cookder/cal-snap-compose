          ...
          <TimeSlotDisplay
            ...
            getEventsForDate={(date: Date) => {
              ...
              return googleEvents.map(event => ({
                ...
                description: undefined, // Google Calendar API doesn't include description in this response
                location: undefined // Google Calendar API doesn't include location in this response
              }));
            }}
            isAllDayEvent={(event: any) => {
              // For converted events, check if start/end are Date objects with times
              return false; // Since we only convert dateTime events, they're never all-day
            }}
            generateSlotsForDuration={(date: Date, blockingEvents: any[], duration: number) => {
              // This is a simplified version for interface compatibility
              // The actual slot generation is handled by fetchCalendarData
              return [];
            }}
